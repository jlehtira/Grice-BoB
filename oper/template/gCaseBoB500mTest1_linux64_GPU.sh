...
export name=Grice-BoB
export dirout=g${name}_out
export diroutdata=${dirout}/data

# "executables" are renamed and called from their directory

# export dirbin=../../../Grice-BoB/DualSPHysics/bin/linux
# export dirbin=../../bin/linux
export dirbin=~/code/Grice-BoB/oper/bin
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${dirbin}
export gencase="${dirbin}/GenCase_linux64"
export dualsphysicscpu="${dirbin}/DualSPHysics5.0_gbobCPU_linux64"
export dualsphysicsgpu="${dirbin}/DualSPHysics5.0_gbob_linux64"
